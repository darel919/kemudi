...
3. Copy the utility contents from macOS Terminal or an editor. If using Terminal, run `pbcopy` in Terminal—not in Studio:
   ...
   ```bash
   cd <repository-root>
   pbcopy < tools/setup_vehicle_asset.luau
   ```
...
2. In macOS Terminal, copy the utility contents:
   ...
   ```bash
   cd <repository-root>
   pbcopy < tools/setup_vehicle_mass_proxies.luau
   ```
...
2. In macOS Terminal, copy the utility contents:
   ...
   ```bash
   cd <repository-root>
   pbcopy < tools/setup_vehicle_beams.luau
   ```
...
```bash
cd <repository-root>
pbcopy < tools/setup_vehicle_dynamics.luau
```
...
2. In macOS Terminal, copy the utility contents:
   ...
   ```bash
   cd <repository-root>
   pbcopy < tools/setup_vehicle_driver_seat.luau
   ```
